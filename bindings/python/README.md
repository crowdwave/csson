...
|---|---|
| **Environment** | Python |
| **Front door** | C ABI (native), WASM fallback |
| **Mechanism** | cffi/ctypes over libcsson (optional C-extension) |
| **Distribution** | PyPI wheel `csson` |
...
2. Wrap it for Python via the mechanism above.
